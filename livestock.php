...
<body>
    ...
    <header>
        ...
        <div class="catalogue-container">
            ...
            $sql = "SELECT productID, productName, category, Price, current_qty, image FROM products WHERE category = 'Livestock'";
            ...
            if ($result->num_rows > 0) {
                ...
                echo "No products found in the Livestock category.";
            }
